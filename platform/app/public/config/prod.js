...
window.config = {
  ...
  dataSources: createDataSources({
    STRAUBING: {
      url: 'https://straubing.deemea.com/api/v1/didier',
      qidoSupportsIncludeField: true,
      supportsReject: true,
    },
    MERMOZ: {
      url: 'https://mermoz.deemea.com/api/v1/didier',
      qidoSupportsIncludeField: true,
      supportsReject: true,
    },
    ERASME: {
      url: 'https://erasme.deemea.com/api/v1/didier',
      qidoSupportsIncludeField: true,
      supportsReject: true,
    },
    LARIBOISIERE_SAAS: {
      url: 'https://lariboisiere-saas.deemea.com/api/v1/didier',
      qidoSupportsIncludeField: true,
      supportsReject: true,
    },
    TRICASE: {
      url: 'https://tricase.deemea.com/api/v1/didier',
      qidoSupportsIncludeField: true,
      supportsReject: true,
    },
    DUBOIS: {
      url: 'https://dubois.deemea.com/api/v1/didier',
      qidoSupportsIncludeField: true,
      supportsReject: true,
    },
    RENACOT: {
      url: 'https://renacot.deemea.com/api/v1/didier',
      qidoSupportsIncludeField: true,
      supportsReject: true,
    },
    PROD_SANTY: {
      url: 'https://santy-prod.deemea.com/api/v1/didier',
      qidoSupportsIncludeField: true,
      supportsReject: true,
    },
